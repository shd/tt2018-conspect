...
\begin{proof}
	...
	\begin{itemize}
		...
		\begin{enumerate}
			\item $x \in \FV(A_{1})$ и $x \in \FV(B_{1})$. По индукционному предположению $A_{1}[x\coloneqq{}Q_{1}] \bpar A_{2}[x\coloneqq{}Q_{2}]$ и $B_{1}[x\coloneqq{}Q_{1}] \bpar B_{2}[x\coloneqq{}Q_{2}]$. Тогда $A_{1}[x\coloneqq{}Q_{1}]B_{1}[x\coloneqq{}Q_{1}] \bpar A_{2}[x\coloneqq{}Q_{2}]B_{2}[x\coloneqq{}Q_{2}]$. Тогда $(A_{1}B_{1})[x\coloneqq{}Q_{1}] \bpar (A_{2}B_{2})[x\coloneqq{}Q_{2}]$.
			\item $x \in \FV(A_{1})$ и $x \notin \FV(B_{1})$. По индукционному предположению $A_{1}[x\coloneqq{}Q_{1}] \bpar A_{2}[x\coloneqq{}Q_{2}]$. Тогда $A_{1}[x\coloneqq{}Q_{1}]B_{1} \bpar A_{2}[x\coloneqq{}Q_{2}]B_{2}$. Тогда $(A_{1}B_{1})[x\coloneqq{}Q_{1}] \bpar (A_{2}B_{2})[x\coloneqq{}Q_{2}]$.
			\item $x \notin \FV(A_{1})$ и $x \in \FV(B_{1})$. Аналогично предыдущему пункту.
		\end{enumerate}
...
\begin{example}
	...
	\begin{enumerate}
		...
		\item  $\comb K \comb I \Omega =_{\alpha} ((\lambda{}a.\lambda{}b.a) \comb I)((\lambda{}x.x \ x) (\lambda{}x.x \ x)) \twoheadrightarrow_{\beta} ((\lambda{}a.\lambda{}b.a) \comb I)((\lambda{}x.x \ x) (\lambda{}x.x \ x)) =_{\alpha} \comb K \comb I \Omega $
	\end{enumerate}
